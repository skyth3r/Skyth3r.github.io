...
Recently I came across a post via my RSS app, where [Jeff Triplett](https://micro.webology.dev/) managed to source a great [animated version of the 'This is fine' background](https://micro.webology.dev/2024/11/08/the-best-animated.html) to be used as a Zoom background.
